...
export default async function HomePage() {
  const [apartments, constructionUpdates] = await Promise.all([
    getApartments(),
            ...
            <div className="storyGrid">
              <figure className="storyCard storyWide">
                <Image
                  ...
                  alt="Monterra Residence z lotu ptaka wieczorem"
                  fill
              ...
              <figure className="storyCard">
                <Image
                  ...
                  alt="Wejście do Monterra Residence"
                  fill
          ...
          <section className="shell section" id="lokalizacja">
            ...
            <div className="locationGrid premiumLocationGrid">
              ...
              <div className="locationPhoto">
                <Image
                  src="/media/aerial-evening.webp"
                  alt="Lokalizacja Monterra Residence w Poznaniu"
                  fill
                  sizes="60vw"
                  className="storyImage"
                />
