      ...
      <main>
        <section className="pageHero compactHero apartmentsPhotoHero">
          <Image
            ...
            alt="Monterra Residence wieczorem"
            fill
            priority
            sizes="100vw"
            className="apartmentsHeroImage"
          />
          ...
          <div className="shell compactHeroInner">
            <div>
              ...
              <p>
                Filtruj ofertę, porównuj ceny i przejdź prosto do interaktywnego
                spaceru po wybranym mieszkaniu.
              </p>
            </div>
            <div className="compactHeroStats">
              <div>
                <strong>{apartments.length}</strong>
                <span>lokali w bazie</span>
              </div>
              <div>
                <strong>{apartments.filter((item) => item.status === "available").length}</strong>
        ...
        <div className="shell section catalogSection">
          <ApartmentCatalog
            ...
            initialFloor={Number.isFinite(floor) ? floor : undefined}
